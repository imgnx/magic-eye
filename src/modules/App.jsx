...
const App = () => {
	...
	img.src="magic-eye-dragon-stereo.png";
	img.onload = drawImageActualSize;
	// document.body.append(img);
	// context.drawImage("magic-eye-dragon-stereo.png");
    ...
    return (
	<main className="container mx-auto relative  min-w-1">
	    <h1 className="text-5xl mb-3">Magic Eye (Autostereogram) Maker</h1>

	    <div className="flex flex-row w-full justify-around">
		<label
		    id="depthLabel"
		    htmlFor="depthFile"
		    className="btn btn-primary text-center !shadow !shadow-[white] px-4 py-1.5 max-w-max"
		>
		    Depth map
		    <input
			id="depthFile"
		...
		<button
		    type="button"
		    className="btn btn-primary flex !text-2xl"
		...
		best. Increase the quality and zoom in! <i role="emoji" alt="magnifying glass" >🔍</i>
	    </div>
	    <div className="relative max-w-[1200px] mx-auto">
	<canvas
		ref={canvasRef}
		className="relative w-[100%] max-w-[100%] min-w-[100%] border border-gray-300"
	    />
	    </div>
	</main>
    );
...
function findDivisiblePatternWidth(
    imageWidth,
    fallback = DEFAULT_PATTERN_WIDTH,
) {
    ...
    for (
	let candidate = MIN_PATTERN_WIDTH;
	candidate <= MAX_PATTERN_WIDTH;
	candidate++
    ) {
